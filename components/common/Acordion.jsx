       ...
       {accordion.map((items, index)=>{
        return(
            ...
            <div className='flex cursor-pointer'>
                ...
                <p className='bg-[#0AA085] p-3'  onClick={()=>setShow(!show)} > {show ? <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
