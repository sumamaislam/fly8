...
import {  masterBlend} from "../../data";
import Link from "next/link";
import { useDispatch, useSelector } from "react-redux";
import Router, { useRouter } from "next/router";
import { wrapper } from "../../store";
import { footerDataRequest, navDataRequest, vapeDataRequest } from "../../redux/home";
  ...
  return (
    <div>
      ...
      <div className="text-center font-bold text-[#5FB75D]">
        <h1 className="pt-[100px] text-[35px] font-bold text-[#5FB75D]">EXCITING FLAVORS OF MASTER BLEND</h1>
      </div>
      <div className=" mt-[100px] container m-auto 2xl:w-[65%]">
        <div className="grid xl:gap-20 gap-12 lg:grid-cols-3 md:grid-cols-2 mt-[28px] justify-center ">
          {vapesData?.MASTER_BLEND?.map((items, index) => {
            return (
