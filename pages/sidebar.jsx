          ...
          <div className="flex h-full flex-col overflow-y-scroll bg-white shadow-xl">
            <div className="flex-1 overflow-y-auto py-6 px-4 sm:px-6">
              ...
              <>
                ...
                <div
                  className={`top-0 right-0 w-[35vw] bg-blue-600  p-10 pl-20 text-white fixed h-full ease-in-out duration-700 z-40  ${showSidebar ? "translate-x-0 " : "translate-x-full"}`}
                >
