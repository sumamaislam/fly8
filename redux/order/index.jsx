...
export const createOrder = createAsyncThunk("order/createOrder", async (payload, thunkAPI) => {
    try {
      ...
      localStorage.setItem("localCart", JSON.stringify({ carts: [], totalPrice: 0, totalQuantity: 0 }));
      toast(<RequestMessage message="Payment Verified!" />);
      toast(<RequestMessage message="Thank you for shopping with us!" />, { autoClose: 8000 });
      Router.push("/");
      return response;
    } catch (error) {
